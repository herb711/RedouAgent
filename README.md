...
- 最新 Release：[Redou Agent v0.1.7](https://github.com/herb711/RedouAgent/releases/tag/v0.1.7)
- Windows 安装包：[Redou-Agent-Setup-0.1.7.exe](https://github.com/herb711/RedouAgent/releases/download/v0.1.7/Redou-Agent-Setup-0.1.7.exe)
- 校验文件：[Redou-Agent-Setup-0.1.7.exe.sha256](https://github.com/herb711/RedouAgent/releases/download/v0.1.7/Redou-Agent-Setup-0.1.7.exe.sha256)
