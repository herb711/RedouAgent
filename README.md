...
- 最新 Release：[Redou Agent v0.1.6](https://github.com/herb711/RedouAgent/releases/tag/v0.1.6)
- Windows 安装包：[Redou-Agent-Setup-0.1.6.exe](https://github.com/herb711/RedouAgent/releases/download/v0.1.6/Redou-Agent-Setup-0.1.6.exe)
- 校验文件：[Redou-Agent-Setup-0.1.6.exe.sha256](https://github.com/herb711/RedouAgent/releases/download/v0.1.6/Redou-Agent-Setup-0.1.6.exe.sha256)
