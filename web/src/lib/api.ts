...
export const api = {
  ...
  getChatProjects: () => fetchJSON<ChatProjectsResponse>("/api/chat/projects"),
  createChatProject: (body: ChatProjectCreateRequest) =>
    fetchJSON<ChatProjectMutationResponse>("/api/chat/projects", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(body),
    }),
  updateChatProject: (projectId: string, body: ChatProjectUpdateRequest) =>
    fetchJSON<ChatProjectMutationResponse>(
  ...
  createChatTask: (projectId: string, body: ChatTaskCreateRequest) =>
    fetchJSON<ChatTaskMutationResponse>(
      `/api/chat/projects/${encodeURIComponent(projectId)}/tasks`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  updateChatTask: (projectId: string, taskId: string, body: ChatTaskUpdateRequest) =>
    fetchJSON<ChatTaskMutationResponse>(
      `/api/chat/projects/${encodeURIComponent(projectId)}/tasks/${encodeURIComponent(taskId)}`,
      {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  getChatTaskMessages: (projectId: string, taskId: string) =>
    fetchJSON<ChatTaskMessagesResponse>(
      `/api/chat/projects/${encodeURIComponent(projectId)}/tasks/${encodeURIComponent(taskId)}/messages`,
    ),
  getProjectContextFile: (projectId: string, kind: ProjectContextFileKind) =>
    fetchJSON<ContextFileResponse>(
      `/api/chat/projects/${encodeURIComponent(projectId)}/context-files/${encodeURIComponent(kind)}`,
    ),
  updateProjectContextFile: (
    ...
    fetchJSON<ContextFileUpdateResponse>(
      `/api/chat/projects/${encodeURIComponent(projectId)}/context-files/${encodeURIComponent(kind)}`,
      {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  getTaskContextFile: (projectId: string, taskId: string, kind: TaskContextFileKind) =>
    fetchJSON<ContextFileResponse>(
      `/api/chat/projects/${encodeURIComponent(projectId)}/tasks/${encodeURIComponent(taskId)}/context-files/${encodeURIComponent(kind)}`,
    ),
...
export type ProjectContextFileKind = "rules" | "memory";
export type TaskContextFileKind = "rules" | "summary";
