...
def test_make_agent_redou_runtime_disables_cross_boundary_toolsets():
    fake_runtime = {
        "provider": "openrouter",
        "base_url": "https://api.synthetic.new/v1",
        "api_key": "sk-test",
    ...
    with (
        patch.dict(
            os.environ,
            {
                "REDOU_PROJECT_ID": "project-1",
                "REDOU_TASK_ID": "task-1",
        ...
        patch(
            ...
            return_value=["memory", "session_search", "skills", "web"],
        ),
        patch(
            "hermes_cli.runtime_provider.resolve_runtime_provider",
            return_value=fake_runtime,
        ...
        _make_agent("sid-redou", "key-redou")
