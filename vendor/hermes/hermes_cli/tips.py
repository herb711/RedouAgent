...
TIPS = [
    ...
    "hermes chat --max-turns 500 overrides the default 200-iteration limit per turn.",
    ...
    "display.busy_input_mode defaults to queue; set interrupt to stop the active run on new input, or steer to inject mid-run via /steer.",
