...
from agent.prompt_builder import (
    DEFAULT_AGENT_IDENTITY, REDOU_AGENT_IDENTITY, PLATFORM_HINTS,
...
class IterationBudget:
    ...
    The parent's budget is capped at ``max_iterations`` (default 200).
...
class AIAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            disabled_tools (List[str]): Disable individual tools after toolset filtering (optional)
        ...
        if result["error"] is not None:
            if deltas_were_sent["yes"]:
                ...
                if _partial_names:
                    ...
                    _warn = (
                        "\n\nWarning: Stream interrupted before completion; "
                        "returned partial output. Ask me to retry if you want "
                        "to continue."
                    )
                    _partial_text = (_partial_text or "") + _warn
                    try:
