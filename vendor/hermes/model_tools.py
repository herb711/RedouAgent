...
Public API:
    get_tool_definitions(enabled_toolsets, disabled_toolsets, quiet_mode, disabled_tools) -> list
...
#  frozenset(disabled_tools), registry._generation).
...
def get_tool_definitions(
    ...
    Args:
        ...
        disabled_tools: Exclude these individual tool names after toolset filtering.
...
def _compute_tool_definitions(
    ...
    if disabled_tools:
        ...
        for tool_name in disabled_tools:
            ...
            if clean and clean in tools_to_include:
                tools_to_include.discard(clean)
                removed.append(clean)
        if removed and not quiet_mode:
