...
describe('normalizeBusyInputMode', () => {
  ...
  it('defaults to queue for missing/unknown values', () => {
    // CLI, gateway, and TUI now share `queue` as the safe default so
    // follow-up messages do not accidentally cancel in-flight work.
