...
const REDOU_AGENT_LOGO_SRC = `${import.meta.env.BASE_URL}redou-agent-logo.png`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <img
          src={REDOU_AGENT_LOGO_SRC}
          alt=""
          aria-hidden="true"
          className="h-7 w-7 shrink-0 rounded-full border border-midground/20 bg-white/95 object-cover p-0.5 opacity-85 shadow-[0_0_14px_rgba(255,230,203,0.12)]"
        />
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <img
                  ...
                  alt=""
                  aria-hidden="true"
                  className="h-9 w-9 shrink-0 rounded-full border border-midground/20 bg-white/95 object-cover p-0.5 opacity-85 shadow-[0_0_18px_rgba(255,230,203,0.14)]"
                />
