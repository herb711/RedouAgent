...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Redou",
    updatingHermes: "Updating Redou…",
  ...
  analytics: {
    ...
    startSession: "Start work to see analytics here",
    date: "Date",
    model: "Model",
    tokens: "Tokens",
    perDayAvg: "/day avg",
  ...
  models: {
    ...
    tokens: "tokens",
    sessions: "runs",
    avgPerSession: "avg/run",
    apiCalls: "API calls",
    toolCalls: "tool calls",
    noModelsData: "No model usage data for this period",
    startSession: "Start work to see model data here",
  },
