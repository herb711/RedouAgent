...
export const zh: Translations = {
  ...
  app: {
    ...
    activeSessionsLabel: "活跃运行：",
    gatewayStatusLabel: "AGENT状态：",
    gatewayStrip: {
      failed: "启动失败",
      off: "关闭",
      running: "运行中",
  ...
  status: {
    ...
    stopped: "已停止",
    updateHermes: "更新 Redou",
    updatingHermes: "正在更新 Redou…",
  ...
  pluginsPage: {
    ...
    missingEnvWarn: "请先设置以下环境变量后再运行插件：",
